...
def doGetGzip(url, headers,charset, data):
...
if __name__ == "__main__":
    import hashlib
    k ='cursor=100&keyword=舞蹈视频抖音女&count=10&type=1&is_pull_refresh=0&hot_search=0&search_source=&search_id=&query_correct_type=1'
    hl = hashlib.md5()
    ...
    result = doGetGzip(url, headers, "UTF-8", data)
